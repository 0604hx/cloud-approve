...
class BaseModel extends Model {
     ...
     * @returns {Number}
     */
    static async count(whereObjOrCol, value){
        let result = await (whereObjOrCol == null? this.query() : value!=undefined ? this.query().where(whereObjOrCol, value):this.query().where(whereObjOrCol)).count()
...
class LinkToProcessModel extends BaseAddonModel {
    /**@type {Number} 关联的流程ID */
    pid     = undefined
    /**
     * 用户ID
...
module.exports = { BaseModel, BaseAddonModel, LinkToProcessModel }
